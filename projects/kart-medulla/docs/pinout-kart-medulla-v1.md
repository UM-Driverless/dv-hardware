# ESP32-S3 (WROOM-1-N16R8) — medulla-v1 PCB

> **v2 Design in progress:** A new board revision is being drawn. For the v2 pinout, see [`pinout-esp32-s3-v2.md`](pinout-esp32-s3-v2.md).
>
> **Authoritative source: the schematic in this same project folder (`../kart-medulla.kicad_sch`).** This document mirrors the v1 pin assignments for human reading and adds rationale/strap-pin/firmware-mode notes that the schematic doesn't carry. When this doc and the schematic disagree, the schematic wins; fix this file. Re-verify before each fab release.
...
## medulla-v2 pin allocation — moved to separate file

The v2 pinout design and rationale have been moved to [`pinout-esp32-s3-v2.md`](pinout-esp32-s3-v2.md) to keep this document strictly focused on the v1 board.
